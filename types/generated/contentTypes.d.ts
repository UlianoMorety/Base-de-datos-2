...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    time_start: Attribute.Time & Attribute.Required;
    time_end: Attribute.Time;
    location: Attribute.String & Attribute.Required;
    type_event: Attribute.Enumeration<
      [
        'Charla',
        'Conferencia',
        'Competencia',
...
export interface ApiInternshipInternship extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date_start: Attribute.Date & Attribute.Required;
    date_end: Attribute.Date;
    requirement: Attribute.Text & Attribute.Required;
    work_area: Attribute.String;
    vacancies: Attribute.Integer & Attribute.DefaultTo<1>;
    keywords: Attribute.String;
...
export interface ApiMentoringMentoring extends Schema.CollectionType {
  ...
  attributes: {
    mentor: Attribute.String & Attribute.Required;
    aprentice: Attribute.String & Attribute.Required;
    date: Attribute.Date & Attribute.Required;
    topics: Attribute.Text & Attribute.Required;
...
export interface ApiProyectProyect extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    description: Attribute.Text & Attribute.Required;
    skill: Attribute.Text & Attribute.DefaultTo<'None'>;
    ...
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    status: Attribute.Enumeration<['Pendiente', 'Terminado', 'Suspendido']> &
      Attribute.Required &
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_type: Attribute.Enumeration<
      ['Estudiante', 'Profesional', 'Mentor', 'Empresa']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Estudiante'>;
    ...
    internships: Attribute.Relation<
      ...
      'api::internship.internship'
    >;
    mentorings: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::mentoring.mentoring'
    >;
    university: Attribute.String;
    studies: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::mentoring.mentoring': ApiMentoringMentoring;
